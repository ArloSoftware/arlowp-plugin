...
<p>
	<label for="<?php echo $this->get_field_id('eventtag'); ?>"><?php _e('Filter by event tag (comma separated)',$this->widget_slug); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('templatetag'); ?>"><?php _e('Filter by template tag (comma separated)',$this->widget_slug); ?>:</label>
...
<p>
	<label for="<?php echo $this->get_field_id('template'); ?>"><?php _e('Custom event template',$this->widget_slug); ?>:</label>
