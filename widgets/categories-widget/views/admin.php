...
<p>
	...
	<small><?php _e('Sets the depth of categories to display. Entering 0 (zero) will display all levels.', $this->widget_slug); ?></small>
</p>
<p>
	<label for="<?php echo $this->get_field_id('parent'); ?>"><?php _e('Match category',$this->widget_slug); ?>:</label>
	...
	<small><?php _e('Checking this box will show only children categories if on a page where the events are being filtered by category.',$this->widget_slug); ?></small>
</p>