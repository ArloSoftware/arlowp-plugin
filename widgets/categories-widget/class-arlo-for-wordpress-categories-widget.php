...
class Arlo_For_Wordpress_Categories_Widget extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'arlo-for-wordpress-categories-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Arlo Categories', 'arlo-training-and-event-management-system' ),
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => esc_html__( 'Display Categories.', 'arlo-training-and-event-management-system' )
			)
		);
	...
	public function form( $instance ) {
		...
		$instance = wp_parse_args(
			(array) $instance,
			array('title'=>'','depth'=> 5,'parent' => false)
		);
...
add_action( 'widgets_init', 'arlo_register_widget_categories_widget' );
function arlo_register_widget_categories_widget() {
	register_widget("Arlo_For_Wordpress_Categories_Widget");
}
