...
class Arlo_For_Wordpress_Admin {
	...
	public function enqueue_admin_scripts() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			wp_enqueue_script( $this->plugin_slug . '-arlo-for-wordpress-script', plugins_url( 'assets/js/arlo_for_wordpress.js?20170424', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), VersionHandler::VERSION, true );
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js?20170424', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), VersionHandler::VERSION, true );
			wp_enqueue_script( $this->plugin_slug . '-fancybox', 'https://cdnjs.cloudflare.com/ajax/libs/fancybox/3.0.47/jquery.fancybox.min.js', array('jquery', 'jquery-ui-core'), '3.3.7', true );
			wp_enqueue_script( $this->plugin_slug . '-plugin-script-cookie', plugins_url( '../public/assets/js/libs/js.cookie.js', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), VersionHandler::VERSION );
		}
	}
